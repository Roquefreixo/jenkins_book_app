...
//CONTROLER QUE HACE DE API REST -> DEVUELVE JSONs
...
public class BookController {
    ...
    public Book updateBook(@RequestBody Book book, @PathVariable Long id) {
        //OJO que se pasa el "id" dentro del body también. Debe coincidir con el
        //"id" de la URL que apunta al resource a hacer el update  
